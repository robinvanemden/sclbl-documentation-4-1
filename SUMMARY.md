...
* [Nx AI Manager plugin v4.x](README.md)
...
* [3. Configure the Nx AI Manager plugin](nx-ai-manager/3.-configure-the-nx-ai-manager-plugin/README.md)
  * [3.1 Model Settings](nx-ai-manager/3.-configure-the-nx-ai-manager-plugin/model-settings.md)
  * [3.2 Model pipeline selection and configuration](nx-ai-manager/3.-configure-the-nx-ai-manager-plugin/model-pipeline-configuration.md)
  * [3.3 Model pipelines on multiple devices](nx-ai-manager/3.-configure-the-nx-ai-manager-plugin/multiple-model-pipelines.md)
* [4. Other Network Optix Plugin Settings](nx-ai-manager/4.-other-network-optix-plugin-settings.md)
* [5. Manual Plugin Installation](nx-ai-manager/5.-manual-plugin-installation.md)
...
* [OpenVino Support](ai-accelerators-support/openvino-support.md)
* [Hailo Support](ai-accelerators-support/hailo-support.md)

## For Data Scientists

* [Introduction](for-data-scientists/introduction.md)
* [About ONNX](for-data-scientists/about-onnx.md)
* [Custom model creation](for-data-scientists/custom-model-creation.md)
* [ONNX requirements](for-data-scientists/onnx-requirements.md)
* [Importing models](for-data-scientists/importing-models/README.md)
  * [From Edge Impulse](for-data-scientists/importing-models/from-edge-impulse.md)
  * [From Nota AI](for-data-scientists/importing-models/from-nota-ai.md)
  * [From Teachable Machine](for-data-scientists/importing-models/from-teachable-machine.md)
  * [From Hugging Face](for-data-scientists/importing-models/from-hugging-face.md)
  * [From Ultralytics](for-data-scientists/importing-models/from-ultralytics.md)
  * [From PyTorch](for-data-scientists/importing-models/from-pytorch.md)
  * [From TensorFlow / TFLite](for-data-scientists/importing-models/from-tensorflow-tflite.md)
  * [From Scikit-learn](for-data-scientists/importing-models/from-scikit-learn.md)
  * [Common Models](for-data-scientists/importing-models/common-models.md)
